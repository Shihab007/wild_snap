...
import { agentClusterOidStoreKey, branchOidStoreKey, branchStoreKey, clusterOidStoreKey, cspOidStoreKey, cspStoreKey, DEFAULT_LANG, emailStoreKey, loginCookieStoreKey, loginOidStoreKey, mobileNoStoreKey, roleIdStoreKey, userIdStoreKey, userNameStoreKey } from 'src/app/common/constant/constant';
...
@Component({
  selector: 'app-app-school',
  templateUrl: './app-school.component.html',
  styleUrls: ['./app-school.component.scss']
})
export class AppSchoolComponent implements OnInit {
