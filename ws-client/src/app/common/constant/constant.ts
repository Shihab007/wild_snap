...
export const REQUEST_SOURCE = 'DOER-ERP';
export const REQUEST_SERVICE_SOURCE = 'schoolerp-portal';


export const DUPLICATE_LOGIN_ID_RESPONSE_CODE = 'Duplicate.Login.Id';
export const DUPLICATE_EIIN_NUMBER_RESPONSE_CODE = 'Duplicate.Eiin.Number';

export const loginCookieStoreKey = 'login.doererp.cookie.store.key';
export const reportJsonCookieStoreKey = 'login.doererp.cookie.store.report.json';
...
export const DEFAULT_APP_LANGUAGE = 'bn';
...
export const DEFAULT_INSTITUTE_LOGO_PATH = 'assets/images/photo/';
...
export const EmailRegEx = '[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$';
export const DEFAULT_IMAGE_SIZE_IN_KB = 200;
export const PERIOD_EN = 'Period';
export const PERIOD_BN = 'পিরিয়ড';
...
export const DEMO_INSTITUTE_OID = 'SCHOOL-ERP-Demo-School-001';

export const ROLE_TYPE_ADMIN = 'Admin';
export const ROLE_TYPE_INSTITUTE = 'Institute';
export const ROLE_TYPE_TEACHER = 'Teacher';
export const ROLE_TYPE_STUDENT = 'Student';
export const ROLE_TYPE_GUARDIAN = 'Guardian';

export const ADMISSION_FEE_HEAD_GROUP_CODE = '101'; 