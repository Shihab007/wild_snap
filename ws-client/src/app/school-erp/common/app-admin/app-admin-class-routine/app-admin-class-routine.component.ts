...
@Component({
  selector: 'app-app-admin-class-routine',
  templateUrl: './app-admin-class-routine.component.html',
  styleUrls: ['./app-admin-class-routine.component.scss']
})
export class AppAdminClassRoutineComponent implements OnInit {
