...
@Component({
  selector: 'app-app-admin-exam',
  templateUrl: './app-admin-exam.component.html',
  styleUrls: ['./app-admin-exam.component.scss']
})
export class AppAdminExamComponent implements OnInit {
