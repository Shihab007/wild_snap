...
@Component({
  selector: 'app-admin-education-shift-view',
  templateUrl: './admin-education-shift-view.component.html',
  styleUrls: ['./admin-education-shift-view.component.scss']
})
export class AdminEducationShiftViewComponent implements OnInit {
