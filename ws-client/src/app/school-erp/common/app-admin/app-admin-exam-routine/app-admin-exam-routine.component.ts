...
@Component({
  selector: 'app-app-admin-exam-routine',
  templateUrl: './app-admin-exam-routine.component.html',
  styleUrls: ['./app-admin-exam-routine.component.scss']
})
export class AppAdminExamRoutineComponent implements OnInit {
