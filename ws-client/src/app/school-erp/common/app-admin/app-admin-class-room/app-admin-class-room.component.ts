...
@Component({
  selector: 'app-app-admin-class-room',
  templateUrl: './app-admin-class-room.component.html',
  styleUrls: ['./app-admin-class-room.component.scss']
})
export class AppAdminClassRoomComponent implements OnInit {
