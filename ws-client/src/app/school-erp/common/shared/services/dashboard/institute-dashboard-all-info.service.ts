...
import { InstituteDashboardAllInfoRequest } from '../../../app-school/app-school-dashboard/model/request/institute-dashboard-all-info-request';
import { Observable } from 'rxjs';
import { environment } from 'src/environments/environment';
import { InstituteDashboardAllInfoResponse } from '../../../app-school/app-school-dashboard/model/response/institute-dashboard-all-info-response';
