...
-- DROP FUNCTION IF EXISTS get_address_json(varchar(128));
CREATE OR REPLACE FUNCTION get_address_json(p_address json)
RETURNS json AS $get_address_json$
    DECLARE
    	v_address				record;
    BEGIN
      ...
      RETURN no_of_student;
    END;
$get_address_json$ LANGUAGE plpgsql;
-- SELECT no_of_student_by_class('10');
